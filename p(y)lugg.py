...
def swedish(options):
    ...
    swedish_words_correct = {"förespråka":"rekommendera", "obefogad":"grundlös"}
    swedish_words_alternatives = {"förespråka":["reflektera", "reservera", "rekommendera", "resonera", "regissera"], "obefogad":["grundlös", "maktlös", "ansvarslös", "gränslös", "meningslös"]}
